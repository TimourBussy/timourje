  ...
  return (
    <header
      className="
                ...
                dark:bg-linear-to-r dark:from-gray-900 dark:to-slate-900 dark:border-sky-950
            "
    >
      <div className="px-4 md:px-8 lg:px-16 xl:px-36 py-6 lg:py-0.75 flex flex-col lg:flex-row items-center lg:justify-between">
        <a
          href="/"
          className="
                        rounded-xs mb-5 lg:mb-0 font-bold text-xl text-transparent bg-clip-text bg-linear-to-r transition-all hover:scale-105
        ...
        <nav className="lg:ml-auto mb-5 lg:mb-0">
          <ul className="flex space-x-5">
            <NavItem to="/">
              {t("header.home", lang === "FR" ? "Accueil" : "Home")}
            </NavItem>
        ...
        >
          <li>
            <HeaderAction onClick={handleLangSwitch}>
