              ...
              <div className="flex flex-col xl:flex-row h-full">
                ...
                >
                  ...
                  <Button
                    ...
                    className="
													  px-6 py-3 rounded-lg text-white font-medium flex gap-2.5 self-start text-center cursor-default bg-linear-to-r transition-transform hover:scale-105
													  from-red-500 to-pink-500
													  dark:from-cyan-500 dark:to-purple-500"
                  >
                    <ExternalLinkIcon className="w-3.5 h-3.5 translate-y-px" />
